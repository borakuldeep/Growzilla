        ...
        NavigationStack {
                    ...
                    if notificationCount == 0 {
                        VStack(spacing: 20) {
                            ...
                            Text("Welcome to Yes You Can!")
                                .font(.title)
                            Text("You daily motivational quote app.")
                                .font(.title3)
                            Text("We believe that words have power to move minds and hearts.")
                                .font(.callout)
                            Text("We hope that these quotes can motivate you to become little wiser everyday and help to make the world a better place.")
                                .font(.callout)
                            Text("Please choose from below categories to start receiving your daily motivational quotes")
                                .font(.callout)

                            // List with custom padding
                            List {
                                Toggle("Life wisdom", isOn: .constant(false))
                                    .toggleStyle(CheckToggleStyle())
                                Toggle("Health", isOn: .constant(false))
                                    .toggleStyle(CheckToggleStyle())
                                Toggle("Motivational", isOn: .constant(true))
                                    .toggleStyle(CheckToggleStyle())
                            }
                ...
                .onAppear {
                    ...
                    notificationTimes =
                        ...
                        as? [[String: Int]] ?? [["hour": 08, "minute": 00]]
